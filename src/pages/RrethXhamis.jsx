...
const LoadingPlaceholder = () => (
  <div className="w-full h-[260px] sm:h-[400px] bg-slate-50 animate-pulse rounded-3xl sm:rounded-[2.5rem] flex items-center justify-center border border-slate-100">
...
export default function RrethXhamis() {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="container py-8 md:py-16 space-y-12 sm:space-y-16 md:space-y-32 mb-8 sm:mb-12 mx-auto"
    >
      <SEO
        title="Rreth Xhamisë"
      ...
      <section className="text-center max-w-4xl mx-auto">
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full bg-emerald-50 text-emerald-700 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] mb-4 sm:mb-6 md:mb-8 border border-emerald-100 shadow-sm">
          <HiSparkles className="text-emerald-500 animate-pulse" /> Historia Jonë
        </motion.div>
        <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-slate-950 mb-4 sm:mb-6 md:mb-10 leading-[1.05] tracking-tighter animate-fade-in-up">
        ...
        <motion.p variants={itemVariants} className="text-base sm:text-lg md:text-2xl text-slate-500 max-w-2xl mx-auto font-medium leading-relaxed">
      ...
      <motion.section variants={itemVariants} className="relative group">
        ...
        <div className="bg-white rounded-3xl sm:rounded-[2.5rem] md:rounded-[3.5rem] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.05)] p-5 sm:p-8 md:p-20 max-w-6xl mx-auto border border-slate-100 relative overflow-hidden">
          ...
          <div className="prose prose-slate prose-lg md:prose-xl max-w-none relative z-10">
            <div className="flex items-center gap-2.5 sm:gap-3 md:gap-4 text-emerald-800 font-black text-sm sm:text-base md:text-xl mb-6 sm:mb-8 md:mb-12 bg-emerald-50 w-fit px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-2xl md:rounded-3xl border border-emerald-100">
              <HiOutlineCalendar className="text-xl sm:text-2xl md:text-3xl text-emerald-600" />
              <span>4 Nëntor 2022</span>
            </div>

            <p className="text-lg sm:text-xl md:text-3xl text-slate-950 leading-[1.4] font-bold mb-8 sm:mb-10 md:mb-14">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-16 mt-8 sm:mt-12 md:mt-20">
              <div className="space-y-5 sm:space-y-6 md:space-y-8">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-slate-900 flex items-center gap-3">
              ...
              <div className="bg-slate-50 p-5 sm:p-6 md:p-10 rounded-2xl sm:rounded-[2rem] md:rounded-[2.5rem] border border-slate-100 space-y-5 sm:space-y-6">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-sm sm:text-base md:text-lg text-slate-700 font-bold">
            ...
            <div className="mt-10 sm:mt-16 md:mt-24 pt-8 sm:pt-10 md:pt-16 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8 text-center md:text-left">
        ...
        <motion.section variants={itemVariants} className="space-y-6 sm:space-y-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-950 tracking-tight">Pamje nga Xhamia</h2>
            </div>
        ...
        <motion.section variants={itemVariants} className="space-y-6 sm:space-y-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-950 tracking-tight">Video</h2>
            </div>
            <div className="hidden md:block w-32 h-1 bg-slate-100 rounded-full" />
          </div>
      ...
      <motion.section variants={itemVariants} className="space-y-6 sm:space-y-8 md:space-y-12 pb-8 sm:pb-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-xl text-center md:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-950 mb-3 sm:mb-4 md:mb-6">Ku ndodhemi?</h2>
            <p className="text-base sm:text-lg text-slate-500 font-medium leading-relaxed">Na vizitoni në lagjen Dushkajë, Kaçanik. Dyer tona janë gjithmonë të hapura për çdo besimtar.</p>
          </div>
        </div>

        <div className="rounded-3xl sm:rounded-[2.5rem] md:rounded-[4rem] overflow-hidden shadow-2xl h-[260px] sm:h-[300px] md:h-[550px] border-4 sm:border-[6px] md:border-[12px] border-white relative">
          <iframe
